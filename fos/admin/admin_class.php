...
//		var_dump($qry->fetch_array());
	...
	function signup(){
		extract($_POST);
                $userRefCode = rand(1000,9999);
              //  var_dump($userRefCode+"is it null");
		...
		$data .= ", password = '".md5($password)."' ";
                ...
                $data .= ", user_referralCode = '$userRefCode' ";
               // var_dump($referral_code);
		//$chkref = $this->db->query("SELECT * FROM user_info where user_referralCode = '$referral_code' ")->num_rowsRef;                $
