            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=googlemap">Contact Us</a></li>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div class="modal fade" id="uni_modal_right" role='dialog'>
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - Online Food Ordering System <a href="https://www.local.hotel.com" target="_blank">AhujaNo1Dhaba</a></div></div>
        </footer>
    ...
    <?php $conn->close() ?>
 <audio autoplay > <!--  loop-->
  <source src="sample.mp3" type="audio/mpeg"/> <!-- works on IE9+, FF3.5+, Chrome4+ -->
  </audio>
</html>
